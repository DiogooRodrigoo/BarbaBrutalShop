  ...
  return (
    <div className="py-10 relative h-[700px]">
      ...
      <div
        ...
        bg-block/80 md:bg-transparent md:bg-gradient-to-r from-black/30 via-black/90 to-black/30
        "
      >
        <MenuSuperior />
        ...
        <div className="container flex-1 flex flex-col justify-center items-center gap-5 z-50">
          <h1 className="flex flex-col items-center">
            <span className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-thin trancking-wider">
              Transformações
            </span>
            <span className="text-gradient text-5x1 sm:text-6xl md:text-7xl lg:text-8xl font-black pb-2">
              Lendarias
            </span>
          </h1>
