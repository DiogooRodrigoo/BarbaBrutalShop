        ...
        {props.labels.map((label, i) => {
          return (
            <div key={i} className="flex items-center gap-2">
              <span
                key={i}
                className={`flex justify-center items-center w-9 h-9 p-1 rounded-full font-bold
    ...
    <div className="flex flex-col gap-10 items-center lg:items-stretch">
      ...
      <div className="flex gap-3 select-none">
        <button
          ...
          className="flex gap-1 items-center bg-zinc-700 text0sm text-white px-4 py-1.5 rounded-md disabled::opcaity-30"
        >
